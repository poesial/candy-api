...
class BlogVariantFactory extends AbstractFactory implements BlogVariantInterface
{
    /**
     * @var \GetCandy\Api\Core\Blogs\Models\BlogVariant
     */
    protected $variant;

    public function init(BlogVariant $variant)
    {
